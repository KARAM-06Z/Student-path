...
$q="SELECT usersID,usersUid,day,month,year FROM students WHERE usersUid=?;";
            ...
            <div class="content_container_inner">
                <div class="my_profile_header_container">
                    ...
                    <div class="profile_id">
                        <div><?php echo $data["usersID"];?></div>
                    </div>
                </div>

                <form action="../INCLUDE/Update_profile.php" method="POST">
                    <input type="hidden" value="<?php echo $data["usersID"]; ?>" name="id">
                    
                    <div class="profile_info_container">
                        <div class="profile_name">
                            <label class="profile_info_tag">Username:</label>
                            <div class="input_control">
                                <div class="name_before"><?php echo $data["usersUid"]; ?></div>
                            </div>
                            <input type="hidden" value="<?php echo $_SESSION["usersUid"]; ?>" name="old_username">
                        </div>
